...
params.params4default = ''
params.params4rcoffee = ''
params.params4mcoffee = ''
params.params4procoffee = ''
params.params4rcoffee_cosan = ''
params.params4quickalign = ''
params.params4psicoffee = ''
params.params43dcoffee = ''
params.params4trmsd = ''
params.params4expresso = ''
params.params4fmcoffee = ''
...
/*    main script flow    */
workflow pipeline {
      TCOFFEE_ANALYSIS(seqs_ch, tcoffee_mode, templates, pair_method)
