...
params.trees ="/users/cn/egarriga/nf_regressive_modules/resultTrees/trees/*.{MAFFT-DPPARTTREE0,FAMSA-SLINK,MBED,MAFFT-PARTTREE0}.dnd"
//params.trees = false
...
// output directory
params.outdir = "$baseDir/result_CompressFalse"
